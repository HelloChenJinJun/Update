...
import com.anew.update.util.JSEngine;
import com.anew.update.bean.VideoBean;
import com.anew.update.api.VideoApi;
import com.anew.update.bean.VideoDetailBean;
import com.anew.update.bean.VideoListBean;
...
public class VideoPresenter extends RxBasePresenter<IView<List<VideoBean>>, DefaultModel> {
    ...
    private String getVideoUrl(String grouopId) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(ConstantUtil.BASE_VIDEO_URL).append("a").append(grouopId).append("/");
    ...
    private String getUrl(boolean isRefresh, String type) {
        ...
        stringBuilder.append(ConstantUtil.BASE_VIDEO_URL).append("api/pc/feed/?max_behot_time=")
    ...
    public void getDetailData(String url) {
        boolean needGetCookie = BaseApplication.getAppComponent().getSharedPreferences()
                .getString(ConstantUtil.GSP, null) == null;
        if (needGetCookie) {
            getCookie(url);
            return;
        }
