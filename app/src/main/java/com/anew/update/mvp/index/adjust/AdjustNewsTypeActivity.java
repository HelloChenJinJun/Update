package com.anew.update.mvp.index.adjust;
...
public class AdjustNewsTypeActivity extends MainBaseActivity {
    ...
    protected void initData() {
        ...
        upAdapter.addData(getComponent().getDefaultRepositoryManager()
        ...
        downAdapter.addData(getComponent().getDefaultRepositoryManager()
                .getDaoSession().getOtherNewsTypeBeanDao().queryBuilder().where(OtherNewsTypeBeanDao.Properties
        ...
        downAdapter.setOnItemClickListener(new OnSimpleItemClickListener() {
            ...
            public void onItemClick(int position, View view) {
                ...
                getComponent().getDefaultRepositoryManager().getDaoSession()
