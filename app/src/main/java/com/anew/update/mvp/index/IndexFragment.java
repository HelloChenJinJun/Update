package com.anew.update.mvp.index;
...
import com.anew.update.adapter.PopWindowAdapter;
import com.anew.update.base.MainBaseFragment;
import com.anew.update.event.TypeNewsEvent;
import com.anew.update.mvp.index.adjust.AdjustNewsTypeActivity;
...
public class IndexFragment extends MainBaseFragment implements View.OnClickListener {
    ...
    protected void initData() {
        ...
        addDisposable(RxBusManager.getInstance().registerEvent(TypeNewsEvent.class, typeNewsEvent -> {
            OtherNewsTypeBean newsTypeBean = getComponent()
                    .getDefaultRepositoryManager().getDaoSession().getOtherNewsTypeBeanDao()
    ...
    private void initFragment() {
        ...
        List<OtherNewsTypeBean> list = getComponent().getDefaultRepositoryManager()
                .getDaoSession()
